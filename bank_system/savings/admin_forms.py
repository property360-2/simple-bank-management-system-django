...
class SavingsProductForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name', 'description', 'interest_rate', 'compounding_frequency', 'min_balance', 'withdrawal_limit', 'penalty_rate', 'is_active']
        widgets = {
            ...
            'withdrawal_limit': forms.NumberInput(attrs={'class': 'form-control form-control-dark', 'placeholder': '6'}),
            'penalty_rate': forms.NumberInput(attrs={'class': 'form-control form-control-dark', 'step': '0.01', 'placeholder': '0.00'}),
